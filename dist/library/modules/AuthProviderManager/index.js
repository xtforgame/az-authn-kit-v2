...
var AuthProviderManager = function (_ModuleBase) {
  ...
  function AuthProviderManager(sequelizeStore, supportedProviders, options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AuthProviderManager).call(this));
...
_defineProperty(AuthProviderManager, "$name", 'authProviderManager');

_defineProperty(AuthProviderManager, "$type", 'service');

_defineProperty(AuthProviderManager, "$inject", ['sequelizeStore']);

_defineProperty(AuthProviderManager, "$funcDeps", {
  init: [],
  start: []
});